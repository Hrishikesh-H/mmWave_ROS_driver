...
{
  new (message_memory) mmwave_radar_interfaces::msg::Heartbeat(_init);
}

void Heartbeat_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mmwave_radar_interfaces::msg::Heartbeat *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Heartbeat_message_member_array[2] = {
  {
    ...
    offsetof(mmwave_radar_interfaces::msg::Heartbeat, builtin_time),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mmwave_radar_interfaces::msg::Heartbeat, frame_count),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Heartbeat_message_members = {
  ...
  2,  // number of fields
  sizeof(mmwave_radar_interfaces::msg::Heartbeat),
...
{
  return &::mmwave_radar_interfaces::msg::rosidl_typesupport_introspection_cpp::Heartbeat_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mmwave_radar_interfaces, msg, Heartbeat)() {
  return &::mmwave_radar_interfaces::msg::rosidl_typesupport_introspection_cpp::Heartbeat_message_type_support_handle;
}
