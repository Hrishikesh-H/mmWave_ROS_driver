...
static const _Heartbeat_type_support_symbol_names_t _Heartbeat_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mmwave_radar_interfaces, msg, Heartbeat)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mmwave_radar_interfaces, msg, Heartbeat)),
  }
};
...
{
  return &::mmwave_radar_interfaces::msg::rosidl_typesupport_cpp::Heartbeat_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mmwave_radar_interfaces, msg, Heartbeat)() {
  return get_message_type_support_handle<mmwave_radar_interfaces::msg::Heartbeat>();
}
