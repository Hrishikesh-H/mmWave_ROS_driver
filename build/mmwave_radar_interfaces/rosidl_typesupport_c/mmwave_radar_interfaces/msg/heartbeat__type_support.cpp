...
#include "mmwave_radar_interfaces/msg/detail/heartbeat__type_support.h"
...
static const _Heartbeat_type_support_symbol_names_t _Heartbeat_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mmwave_radar_interfaces, msg, Heartbeat)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mmwave_radar_interfaces, msg, Heartbeat)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mmwave_radar_interfaces, msg, Heartbeat)() {
  return &::mmwave_radar_interfaces::msg::rosidl_typesupport_c::Heartbeat_message_type_support_handle;
}
