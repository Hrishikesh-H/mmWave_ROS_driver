...
#include "mmwave_radar_interfaces/msg/detail/header__type_support.h"
...
static const _Header_type_support_symbol_names_t _Header_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mmwave_radar_interfaces, msg, Header)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mmwave_radar_interfaces, msg, Header)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mmwave_radar_interfaces, msg, Header)() {
  return &::mmwave_radar_interfaces::msg::rosidl_typesupport_c::Header_message_type_support_handle;
}
