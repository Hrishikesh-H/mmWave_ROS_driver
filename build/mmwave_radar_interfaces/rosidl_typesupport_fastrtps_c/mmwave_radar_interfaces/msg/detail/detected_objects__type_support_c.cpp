...
#include "mmwave_radar_interfaces/msg/detail/detected_objects__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // velocity, x, y, z
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // velocity, x, y, z

// forward declare type support functions


using _DetectedObjects__ros_msg_type = mmwave_radar_interfaces__msg__DetectedObjects;
...
size_t get_serialized_size_mmwave_radar_interfaces__msg__DetectedObjects(
  const void * untyped_ros_message,
...
static uint32_t _DetectedObjects__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mmwave_radar_interfaces__msg__DetectedObjects(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mmwave_radar_interfaces
size_t max_serialized_size_mmwave_radar_interfaces__msg__DetectedObjects(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mmwave_radar_interfaces__msg__DetectedObjects;
    is_plain =
      (
...
static size_t _DetectedObjects__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mmwave_radar_interfaces__msg__DetectedObjects(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mmwave_radar_interfaces, msg, DetectedObjects)() {
