...
#include "mmwave_radar_interfaces/msg/detail/heartbeat__rosidl_typesupport_fastrtps_c.h"
...
#include "builtin_interfaces/msg/detail/time__functions.h"  // builtin_time
...
using _Heartbeat__ros_msg_type = mmwave_radar_interfaces__msg__Heartbeat;
...
size_t get_serialized_size_mmwave_radar_interfaces__msg__Heartbeat(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Heartbeat__ros_msg_type * ros_message = static_cast<const _Heartbeat__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_builtin_interfaces__msg__Time(
    &(ros_message->builtin_time), current_alignment);
  // field.name frame_count
  {
...
static uint32_t _Heartbeat__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mmwave_radar_interfaces__msg__Heartbeat(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mmwave_radar_interfaces
size_t max_serialized_size_mmwave_radar_interfaces__msg__Heartbeat(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mmwave_radar_interfaces__msg__Heartbeat;
    is_plain =
      (
      offsetof(DataType, frame_count) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Heartbeat__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mmwave_radar_interfaces__msg__Heartbeat(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mmwave_radar_interfaces, msg, Heartbeat)() {
