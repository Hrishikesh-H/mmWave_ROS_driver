...
bool mmwave_radar_interfaces__msg__detected_objects__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mmwave_radar_interfaces.msg._detected_objects.DetectedObjects", full_classname_dest, 61) == 0);
  }
  mmwave_radar_interfaces__msg__DetectedObjects * ros_message = _ros_message;
  {  // num_obj
    PyObject * field = PyObject_GetAttrString(_pymsg, "num_obj");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->num_obj = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // x
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * mmwave_radar_interfaces__msg__detected_objects__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of DetectedObjects */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mmwave_radar_interfaces.msg._detected_objects");
  ...
  mmwave_radar_interfaces__msg__DetectedObjects * ros_message = (mmwave_radar_interfaces__msg__DetectedObjects *)raw_ros_message;
  {  // num_obj
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->num_obj);
    {
      int rc = PyObject_SetAttrString(_pymessage, "num_obj", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
