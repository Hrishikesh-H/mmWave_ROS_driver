    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'mmwave_radar_interfaces.msg.Heartbeat')
            logger.debug(
...
class Heartbeat(metaclass=Metaclass_Heartbeat):
    ...
    def __init__(self, **kwargs):
        ...
        from builtin_interfaces.msg import Time
        self.builtin_time = kwargs.get('builtin_time', Time())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.builtin_time != other.builtin_time:
            return False
    ...
    def builtin_time(self):
        """Message field 'builtin_time'."""
        return self._builtin_time

    @builtin_time.setter
    def builtin_time(self, value):
        if __debug__:
            from builtin_interfaces.msg import Time
            assert \
                isinstance(value, Time), \
                "The 'builtin_time' field must be a sub message of type 'Time'"
        self._builtin_time = value
