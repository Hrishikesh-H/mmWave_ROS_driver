...
#include "mmwave_radar_interfaces/msg/detail/heartbeat__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mmwave_radar_interfaces::msg::Heartbeat & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: builtin_time
  builtin_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.builtin_time,
    cdr);
  // Member: frame_count
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mmwave_radar_interfaces::msg::Heartbeat & ros_message)
{
  // Member: builtin_time
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mmwave_radar_interfaces::msg::Heartbeat;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mmwave_radar_interfaces::msg::Heartbeat *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mmwave_radar_interfaces::msg::Heartbeat *>(
    untyped_ros_message);
...
get_message_type_support_handle<mmwave_radar_interfaces::msg::Heartbeat>()
{
  return &mmwave_radar_interfaces::msg::typesupport_fastrtps_cpp::_Heartbeat__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mmwave_radar_interfaces, msg, Heartbeat)() {
  return &mmwave_radar_interfaces::msg::typesupport_fastrtps_cpp::_Heartbeat__handle;
}
